...
/***/ function(module, exports, __webpack_require__) {
	...
	var _serviceTestService = __webpack_require__(29);
	
	var _serviceTestService2 = _interopRequireDefault(_serviceTestService);
	
	var _utilsFetchJs = __webpack_require__(25);
	
	var _utilsFetchJs2 = _interopRequireDefault(_utilsFetchJs);
	...
	$(function () {
	    new _serviceTestService2['default']();
	    //除了这种方式获取dev环境的url，还可以通过调用ENV.getAjaxUrl(url)方式获取
	
	    _utilsFetchJs2['default']('/test?id=1', {
	        type: 'POST',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jqModal = __webpack_require__(30);
	
	var _templateLoginHtml = __webpack_require__(41);
	
	var _templateLoginHtml2 = _interopRequireDefault(_templateLoginHtml);
	
	//如果要调用Handlebars其他方法，如registerHelper，则需要手动引入
	
	var _handlebarsRuntime = __webpack_require__(3);
	...
	var TestService = (function () {
	    function TestService() {
	        ...
	        _handlebarsRuntime2['default'].registerHelper("debug", function (optionalValue) {
	    ...
	    TestService.prototype.showDialog = function showDialog() {
	        $('#login').html(_templateLoginHtml2['default']({
	            title: '登陆',
	            content: '请登录',
	            footer: ''
	        })).mask();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateDialogHtml = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateConfirmHtml = __webpack_require__(38);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"f-modal confirm\">\n    <div class=\"close modal-close\"></div>\n    <div class=\"header\">"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</div>\n    <div class=\"content\">"
	    + alias4(((helper = (helper = helpers.message || (depth0 != null ? depth0.message : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"message","hash":{},"data":data}) : helper)))
	    + "</div>\n    <div class=\"footer\">\n        <button class=\"success modal-success\">"
	    ...
	    + "</button>\n        <button class=\"cancel modal-cancel\">"
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templateAlertHtml = __webpack_require__(40);
