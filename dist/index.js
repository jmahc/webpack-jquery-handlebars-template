...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsPerformAction = __webpack_require__(24);
	
	var _utilsPerformAction2 = _interopRequireDefault(_utilsPerformAction);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = function (actionName, fn) {
	    if (fn && fn instanceof Function) {
	
	        if (typeof window.ENV == 'undefined' || window.ENV && (typeof ENV.dev == 'undefined' || ENV.dev == false || ENV.actionName == actionName)) {
	            (function () {
	                ...
	                if (typeof ENV != 'undefined' && ENV.dev) {
	                    ...
	                    getAjaxUrl = function (url) {
	                        url = url.split('?');
	                        return location.pathname.substr(0, location.pathname.lastIndexOf('/') + 1) + 'mocks' + url[0] + '.json';
	                    };
	                }
	                if (window.ENV) {
	                ...
	                $(function () {
	                    ...
	                    fn(function (url, options) {
	                        options.isDev = isDev;
	                        return _fetch2['default'](getAjaxUrl(url), options);
	                    }, getAjaxUrl);
	                });
	            })();
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {//默认就是json数据请求
